...
export async function PUT(request, { params }) {
  try {
    ...
    const updatedEvent = await prisma.event.update({
      where: { id: Number(params.id) },
      data: {
        title: formData.get('title') || existingEvent.title,
        date: new Date(formData.get('date') || existingEvent.date),
        location: formData.get('location') || existingEvent.location,
        description: formData.get('description') || existingEvent.description,
        imageUrl
      }
    })
